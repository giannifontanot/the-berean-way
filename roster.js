...
window.ROSTER = {
  "s-122aef50": {
    ...
    series: {
      ...
      evangelismo: [true, false, true, true, true, true, true, true, true, true]
    }
  },
  "s-7f3a9c2e": {
    student: "Samuel",
